...
const (
	...
	maxFlateBlockTokens = 1 << 11 // 1 << 14 修改为 1 << 11
	maxStoreBlockSize   = 2048    // 默认65535, 修改为2048
	hashBits            = 12      // After 17 performance degrades, 默认17, 修改为12
	hashSize            = 1 << hashBits
